...
def handle_client(conn):
    try:
        ...
        if operation in ['add', 'subtract']:
            ...
            # Step 2: Get encrypted client value
            ...
            # Step 3: Encrypt the server dataset
            encrypted_server_dataset = [pub_key.encrypt(val) for val in server_dataset]

            # Step 4: Perform encrypted operations
            ...
            # TenSEAL part for multiply, divide, etc.
            ...
            for val in server_dataset:
                ...
                if operation == 'multiply':
                    ...
                    enc_cube = (enc_val * enc_val)
                    enc_cube = enc_cube * enc_val
                    res = enc_cube
