    ...
    try:
        ...
        if scheme == 'paillier':
            ...
            if operation in ['add', 'subtract', 'multiply', 'divide', 'square', 'cube', 'percentage']:
                ...
                if scheme == 'ckks':
                    if operation == 'cube':
                        array_dataset = dataset.ckks_cube_array
                    else: array_dataset = dataset.ckks_normal_array
                elif scheme =='bfv':
                    array_dataset=dataset.bfv_normal_array
                ...
                array_dataset = dataset.bfv_memebership_array
                for val in array_dataset:
