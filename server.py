...
def handle_client(conn):
    ...
    try:
        ...
        server_dataset_dot = np.array([[1.0, 2.0], [3.0, 4.0]])  # For dot product
        ...
        if scheme == 'paillier':
            ...
            if operation in ['add', 'subtract']:
                ...
                for enc_server_val in encrypted_server_dataset:
                    ...
                    difference_results.append({'ciphertext': enc_diff.ciphertext(), 'exponent': enc_diff.exponent})

                results = difference_results
            ...
            if operation in ['add', 'subtract', 'multiply', 'divide', 'square', 'cube', 'percentage']:
                ...
                array_dataset = [122.0, 90.0] if scheme == 'ckks' else [12, 24]
                ...
                for val in array_dataset:
                    ...
                    if operation == 'add':
                        ...
                        squared = ts.ckks_vector_from(context, squared.serialize()) if scheme == 'ckks' else squared
                        res = squared * enc_val
